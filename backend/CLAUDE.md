# espresso backend — agent context
...
unsupported. Opposite direction words are recorded (`direction_conflict`) but not shown:
five of five flags on the library were false alarms; see FINDINGS. The page opens the
