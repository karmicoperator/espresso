# Paper in Five reader

Next.js app. Run it through `PaperInFive.app` or `./start.command` from the repo root; both
...
`PAPERINFIVE_DEV=1 ./start.command` runs the dev server instead.
